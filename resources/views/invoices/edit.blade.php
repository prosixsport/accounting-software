                ...
                <table class="table table-bordered align-middle" id="itemsTable">
                    ...
                    <tbody>
                        @foreach($invoice->items as $item)
                            <tr>
                                <td><input type="text" name="item_name[]" value="{{ $item->item_name }}" class="form-control" required></td>
                                <td><input type="text" name="description[]" value="{{ $item->description }}" class="form-control"></td>
                                <td><input type="number" step="0.01" name="qty[]" value="{{ $item->qty }}" class="form-control qty" required></td>
                                <td><input type="number" step="0.01" name="rate[]" value="{{ $item->rate }}" class="form-control rate" required></td>
                                <td><input type="number" step="0.01" class="form-control amount" value="{{ $item->amount }}" readonly></td>
            ...
            <div class="row justify-content-end">
                <div class="col-md-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" id="subtotal" value="{{ $invoice->subtotal }}" class="form-control" readonly>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Discount</label>
                        <input type="number" step="0.01" name="discount" id="discount" value="{{ $invoice->discount }}" class="form-control">
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Tax</label>
                        <input type="number" step="0.01" name="tax" id="tax" value="{{ $invoice->tax }}" class="form-control">
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Paid Amount</label>
                        <input type="number" step="0.01" name="paid_amount" id="paid_amount" value="{{ $invoice->paid_amount }}" class="form-control">
                    </div>

                    <div class="mb-3">
                        <label class="form-label fw-bold">Grand Total</label>
                        <input type="number" id="grand_total" value="{{ $invoice->total_amount }}" class="form-control fw-bold" readonly>
                    </div>

                    <div class="mb-3">
                        <label class="form-label fw-bold">Balance</label>
                        <input type="number" id="balance" value="{{ $invoice->balance_amount }}" class="form-control fw-bold" readonly>
                    </div>
